...
class MessagingController {
    ...
    async sendText(req, res) {
        try {
            ...
            const result = await messaging_service_1.messagingService.sendText(userId, request);
            if (!result.success) {
                res.status(400).json({
                    success: false,
                    error: {
    ...
    async sendMedia(req, res) {
        try {
            ...
            const result = await messaging_service_1.messagingService.sendMedia(userId, request);
            if (!result.success) {
                res.status(400).json({
                    success: false,
                    error: {
    ...
    async sendLocation(req, res) {
        try {
            ...
            const result = await messaging_service_1.messagingService.sendLocation(userId, request);
            if (!result.success) {
                res.status(400).json({
                    success: false,
                    error: {
    ...
    async sendContact(req, res) {
        try {
            ...
            const result = await messaging_service_1.messagingService.sendContact(userId, request);
            if (!result.success) {
                res.status(400).json({
                    success: false,
                    error: {
    ...
    async sendPresence(req, res) {
        try {
            ...
            const request = { sessionId, to, presence };
            const result = await messaging_service_1.messagingService.sendPresence(userId, request);
            if (!result.success) {
                res.status(400).json({
                    success: false,
    ...
    async markAsRead(req, res) {
        try {
            ...
            const request = { sessionId, to, messageIds };
            const result = await messaging_service_1.messagingService.markAsRead(userId, request);
            if (!result.success) {
                res.status(400).json({
                    success: false,
