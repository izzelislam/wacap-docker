...
class SessionController {
    ...
    list(req, res) {
        try {
            ...
            const sessions = session_service_1.sessionService.list(userId);
            res.json({
                success: true,
                data: {
                    sessions
    ...
    async create(req, res) {
        try {
            ...
            const session = await session_service_1.sessionService.create(userId, sessionId.trim(), name?.trim() || undefined);
            res.status(201).json({
                success: true,
                data: {
                    session
    ...
    async stop(req, res) {
        try {
            ...
            const stopped = await session_service_1.sessionService.stop(userId, sessionId);
            if (!stopped) {
                res.status(404).json({
                    success: false,
                    error: {
    ...
    async delete(req, res) {
        try {
            ...
            const deleted = await session_service_1.sessionService.delete(userId, sessionId);
            if (!deleted) {
                res.status(404).json({
                    success: false,
                    error: {
    ...
    getQR(req, res) {
        try {
            ...
            const qrData = session_service_1.sessionService.getQR(userId, sessionId);
            if (!qrData) {
                res.status(404).json({
                    success: false,
                    error: {
    ...
    async restart(req, res) {
        try {
            ...
            const session = await session_service_1.sessionService.restart(userId, sessionId);
            if (!session) {
                res.status(404).json({
                    success: false,
                    error: {
