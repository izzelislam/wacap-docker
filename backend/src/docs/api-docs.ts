...
// This file contains JSDoc comments for swagger-jsdoc to generate OpenAPI documentation
// The actual route implementations are in their respective controller files
export {};
