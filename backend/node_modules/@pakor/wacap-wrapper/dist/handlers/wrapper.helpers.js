...
exports.smartFormatJid = smartFormatJid;
 ...
 */
function formatJid(input, isGroup, isLid) {
    if (!input) {
 ...
 */
function formatJids(inputs, isGroup, isLid) {
